        ...
        function recordprofile(itrec, nz,z,age,pt,msed,wi,rho,cc,ccx,dic,dicx,alk,alkx,co3,co3x,co3sat ...
            ...
            if (itrec==0)
                ...
                if global_var.user_plot
                    ...
                    legend('CaCO_{3} trend','Actual model points');
                    figure;
                    hold on;
                    ...
                    ylabel('Depth below sediment surface (cm)');
                    legend('CaCO_{3} dissolution','Organic carbon fraction 1 oxidation','Organic carbon fraction 2 oxidation');
                    figure;
                    hold on;
                    ...
                    xlabel('Porewater concentration (umol kg^{-1})');
                    ylabel('Depth below sediment surface (cm)');
                    legend('Dissolved O_{2}','Carbonate ion concentration');
                end
                %
            end
            % *********************************************************** %          
