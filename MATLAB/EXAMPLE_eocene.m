...
user_cc_rain_flx_in=16.0;   % [16.0] influx of CaCO3 [umol cm-2 yr-1]
user_rainratio_in=1.0;      % [1.0] assumed OM/CaCO3-ratio [dimensionless]
user_dep_in=3.5;            % [3.5] seafloor water depth [km]
user_alk=2021.0;            % [2021.0] seaflood ALK [umol kg-1]
user_dic=2017.0;            % [2278.0] seafloor DIC [umol kg-1]
user_o2=158.0;              % [158.0] seafloor O2 [umol kg-1]
user_ca=18.3;               % [18.3] seafloor Ca [mmol kg-1]
%
